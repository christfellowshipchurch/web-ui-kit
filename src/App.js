...
const options1 = ['Option', 'Option', 'Option',]
const options2 = [
  ...
  return (
    <React.Fragment>
      <div className="container my-5 py-5 bg-white">
        ...
        <div className="row">
          <div className="col-6 p-3">
            <Dropdown label="Dropdown" options={options1} />
          </div>
          <div className="col-6 p-3">
            <Dropdown label="Dropdown" options={options2} />
          </div>
        </div>
      </div>
      ...
      <div className='container mt-5'>
        <div className="row">
          <div className="col-6 p-5 bg-white">
            <Button type="primary" title="Default" loading />
          </div>
          <div className="col-6 p-5 bg-white">
        ...
        <div className="row">
          <div className="col-6 p-5 bg-white">
            <Button type="dark" title="Default" loading />
          </div>
          <div className="col-6 p-5 bg-white">
        ...
        <div className="row">
          <div className="col-6 p-5 bg-dark">
            <Button type="light" title="Default" loading />
          </div>
          <div className="col-6 p-5 bg-dark">
